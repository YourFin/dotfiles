...
## Begin p10k.zsh
#########################
# Generated by Powerlevel10k configuration wizard on 2020-04-14 at 19:12 PDT.
...
() {
  ...
  # Can the terminal properly render multi-width symbols
  ...
  function my_git_formatter() {
    ...
    #  42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}$stash_sym${VCS_STATUS_STASHES}"
    #  42 if behind the remote.
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}$download_sym${VCS_STATUS_COMMITS_BEHIND}"
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}$staged_sym${VCS_STATUS_NUM_STAGED}"
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='partial | fail'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=232
  ...
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND=232
  # Custom icon.
